...
// earlier revision of this preset (a) inserted a colon after "Agreed
// factual record" that the dossier's own heading does not have, and (b)
// appended an invented sentence to every Judge personality --
// "These are research-based simulations of documented judicial method
// and writing characteristics; they do not impersonate the judge or
// predict how the real judge would decide this fictional case." -- text
// that does not appear in the dossier at all (it was constructed from
// context, not transcribed). Both are corrected below: the colon is
// removed, and that sentence no longer appears in any Judge personality
// string. The dossier's actual global disclaimer -- present once, on its
// own title page, not per-judge -- is preserved verbatim as
// JON_SNOW_DOSSIER_DISCLAIMER and displayed once on the demo's settings
// screen, never folded into a personality field.
...
// The dossier's own global disclaimer, page 1, transcribed verbatim and
// in full -- not a per-judge sentence. Displayed once on the demo's
// settings screen (Issue #32/PR #34 correction; Sec 21).
export const JON_SNOW_DOSSIER_DISCLAIMER =
